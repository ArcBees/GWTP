...
/**
 * This is a basic implementation of a {@link Tab} that must be subclassed.
...
public abstract class BaseTab extends Composite implements Tab {
  ...
  /**
   * Checks whether or not the current user has the right to access this tab. By
   * default, all tabs can be accessed.
   * 
