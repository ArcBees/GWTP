 ...
 * <p />
 * The String constants are used within the {@link NameToken} annotations, which
 * can't use a method. The static method corresponding to these constants are
 * used within UiBinder which can't access static fields.
 * <p />
