 ...
 *          {@link TabPanel}.
 * @param <P>
 *          The specific type of the {@link Proxy}.
 */
public abstract class HomePresenterBase<V extends View & TabPanel, P extends Proxy<?>> extends
    TabContainerPresenter<V, P> {
  public HomePresenterBase(EventBus eventBus, V view, P proxy, Type<RequestTabsHandler> requestTabsEventType,
