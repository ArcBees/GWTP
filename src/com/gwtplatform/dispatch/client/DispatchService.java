...
/**
 * The base class of the synchronous dispatcher service. The server-side implementation is {@link com.gwtplatform.dispatch.server.DispatchServiceImpl}
 * and the async client-side version is {@link DispatchServiceAsync}.
 * <p />
 * This class is closely related to {@link com.gwtplatform.dispatch.server.Dispatch}, in theory the latter wouldn't
