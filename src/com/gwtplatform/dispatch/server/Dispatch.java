 ...
 * The server-side implementation is {@link com.gwtplatform.dispatch.server.DispatchImpl}
 * and the async client-side version is {@link DispatchAsync}.
 * <p />
 * This class is closely related to {@link com.gwtplatform.dispatch.server.DispatchService}.
 * In fact, this class wouldn't be needed, but we use it to workaround a GWT 
 * limitation described in {@link com.gwtplatform.dispatch.client.DispatchAsync}.
 * 
