...
public abstract class AbstractPresenterModule extends AbstractGinModule {
   ...
   * @param presenterImpl   The {@link PresenterWidget} implementation (NOT a singleton).
   ...
   * @param presenterImpl   The {@link PresenterWidget} implementation (a singleton).
   * @param view     The {@link View} interface.
   ...
   * many presenters. As such, you will need to also use the {@link #bindSharedView} method.
   * If the view class is use only by one presenter, you should consider using
   * {@link #bindPresenterCustomProxy(Class, Class, Class, Class, Class, Class)} instead.
   *
   * @param <P>         The {@link Presenter} interface type.
   * @param <Proxy_>    The {@link Proxy} type.
   * @param presenter   The {@link Presenter} interface.
   ...
   * with non-singleton views, for example when the same view class is reused with 
   * many presenters. As such, you will need to also use the {@link #bindSharedView} method.
   * If the view class is used only by one presenter, you should consider using
   * {@link #bindPresenterCustomProxy(Class, Class, Class, Class, Class)} instead.
   *
   * @param <P>         The {@link Presenter} class type.
   * @param <Proxy_>    The {@link Proxy} type.
   * @param presenterImpl   The {@link Presenter} implementation (a singleton).
   ...
   * {@link #bindPresenter(Class, Class)}, {@link #bindPresenter(Class, Class, Class)},
   * {@link #bindPresenterCustomProxy(Class, Class, Class)}, or
   * {@link #bindPresenterCustomProxy(Class, Class, Class, Class)},
   * If the view class is use only by one presenter, you should consider using
   * {@link #bindPresenter(Class, Class, Class, Class, Class)} instead.
   *
   * @param <V>      The {@link View} interface type.
