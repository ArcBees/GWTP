...
/**
 * <b>Important!</b> For testing purposes only, this class shouldn't be included in
 * official releases.
 * 
 ...
 * you will see the HTML code of the google search page. <p />
 * If you navigate to: <br />
 * {@code http://myapp.appspot.com?_url_=http://myapp.appspot.com/staticPage.html} <br />
 * you will see the HTML code of your static page. <p />
 * If you navigate to: <br />
 * {@code http://myapp.appspot.com?_url_=http://myapp.appspot.com/dynamicPage.jsp} <br />
 * the you will not see any HTML code.
 * <p />
 * Analyzing the App Engine logs (provided you configure your app to log {@code Info} 
 * messages, in your {@code logging.properties} file) will show that the request for
 * {@code http://myapp.appspot.com/dynamicPage.jsp} is processed <i>after</i> the
 * request for {@code http://myapp.appspot.com} has terminated (with an exception).
 * This seems to hint at the fact that AppEngine's servlet container does not
 * allocate a new thread for the second request.
 * 
...
public final class TestFetchUrlFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response,
    ...
    if ((queryString != null) && (queryString.contains(REQUEST_URL_FORMAT))) {
      String pageName = queryString.substring( queryString.indexOf(REQUEST_URL_FORMAT) + REQUEST_URL_LENGTH);
