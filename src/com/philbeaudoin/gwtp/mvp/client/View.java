...
public interface View {
   ...
   * <p />
   * Override the default implementation and manage all the slots
   * of your view into which content can be placed. 
   * If the view doesn't know about this slot, it can silently 
   * ignore the request. When {@code null} is passed, your implementation 
   ...
   * <p />
   * Override the default implementation and manage all the slots
   * of your view into which content can be added. You should
   * also consider over overriding {@link #removeContent(Object, Widget)}.
   * If the view doesn't know about this slot, it can silently 
   * ignore the request.
   * <p />
   ...
   * <p />
   * Override the default implementation and manage all the slots
   * of your view into which content can be added and removed. You should
   * also override {@link #addContent(Object, Widget)}.
   * If the view doesn't know about this slot, it can silently 
   * ignore the request.
   * <p />
