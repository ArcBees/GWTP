...
import com.gwtplatform.dispatch.server.guice.overridesop.AbstractDispatchServiceImpl;
import com.gwtplatform.dispatch.shared.SecurityCookie;

/**
 * This overrides GWT SOP. This can be used with a remote device setup.
 * 
 * Serve this through the Default Servlet Module
 * serve("/" + ActionImpl.DEFAULT_SERVICE_NAME + "*").with(DispatchServiceImplOverrideSop.class);
 * 
 * TODO investigate security for this type of context  
 * 
