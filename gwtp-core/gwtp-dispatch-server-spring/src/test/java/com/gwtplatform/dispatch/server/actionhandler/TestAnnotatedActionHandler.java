...
public class TestAnnotatedActionHandler extends AbstractActionHandler<TestAnnotatedAction, TestResult> {
    ...
    public TestAnnotatedActionHandler() {
        super(TestAnnotatedAction.class);
    }

    @Override
    public TestResult execute(TestAnnotatedAction action, ExecutionContext context) throws ActionException {
    ...
    @Override
    public void undo(TestAnnotatedAction action, TestResult result, ExecutionContext context) throws ActionException {
        // No undo support
    }
}
