...
public class QueryVariableInitializerProcessor extends AbstractHttpVariableInitializerProcessor {
    @Override
    ...
    protected CodeSnippet process(HttpVariable httpVariable, String httpNameArgument, String variableNameArgument,
        ...
        return buildConstructorCall(QueryParameter.class, httpNameArgument, variableNameArgument, dateFormatArgument,
                "urlUtils");
    }
}
