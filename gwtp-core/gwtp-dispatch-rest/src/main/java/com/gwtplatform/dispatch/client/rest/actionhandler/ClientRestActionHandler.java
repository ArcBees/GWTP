...
/**
 * Instances of this interface will handle specific types of {@link RestAction} classes on the client.
 * <p/>
 ...
 * </pre>
 *
 * @param <A> The type of the action extending {@link RestAction}.
...
public interface ClientRestActionHandler<A extends RestAction<R>, R> {
     ...
     * @return A {@link com.gwtplatform.dispatch.shared.DispatchRequest} object. Never return {@code null},
     *         instead return a new {@link com.gwtplatform.dispatch.client.CompletedDispatchRequest}
