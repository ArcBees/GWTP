...
public class FormVariableInitializerProcessor extends AbstractHttpVariableInitializerProcessor {
    @Override
    ...
    protected CodeSnippet process(HttpVariable httpVariable, String httpNameArgument, String variableNameArgument,
        ...
        return buildConstructorCall(FormParameter.class, httpNameArgument, variableNameArgument, dateFormatArgument,
                "urlUtils");
    }
}
