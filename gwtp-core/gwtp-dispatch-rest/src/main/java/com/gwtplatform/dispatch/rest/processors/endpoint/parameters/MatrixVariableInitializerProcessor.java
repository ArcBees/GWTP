...
public class MatrixVariableInitializerProcessor extends AbstractHttpVariableInitializerProcessor {
    @Override
    ...
    protected CodeSnippet process(HttpVariable httpVariable, String httpNameArgument, String variableNameArgument,
        ...
        return buildConstructorCall(MatrixParameter.class, httpNameArgument, variableNameArgument, dateFormatArgument,
                "urlUtils");
    }
}
