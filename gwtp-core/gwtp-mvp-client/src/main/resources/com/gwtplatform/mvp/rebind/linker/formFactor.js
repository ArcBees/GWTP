...
function findFormFactorFromUserAgent(userAgent) {
    var mobileRe = /(iPhone|iPod|Mobi|Mini|Fennec|HTC|j2me|J2ME|Symbian|Puffin|portalmmm|PSP|Palm|DoCoMo|webOS|MMP|MIDP|UCBrowser|WindowsCE|Novarra-Vision|BOLT|SonyEricsson|Android 0|UP\.Link)/;
