 ...
 * correspond to a singleton {@link GenericPresenter}. If you need to separate logic from view
 ...
 */
@Singleton
public abstract class GenericPresenter<RevealType, S, V extends View, Proxy_ extends Proxy<?>>
     ...
     */
    public GenericPresenter(boolean autoBind, EventBus eventBus, V view, Proxy_ proxy) {
        super(eventBus, view);
        this.proxy = proxy;
    }

    /**
     * Creates a {@link GenericPresenter} that uses automatic binding. This will
     ...
     * @param proxy    The {@link Proxy}.
     */
    public GenericPresenter(EventBus eventBus, V view, Proxy_ proxy) {
     ...
     * For more details see {@link GenericPresenter}.
     */
     ...
     * {@link com.gwtplatform.mvp.client.proxy.ProxyPlace#manualReveal(GenericPresenter)} when
     ...
     * to this {@link GenericPresenter}. You should override the method to extract any
