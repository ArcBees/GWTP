...
import com.gwtplatform.mvp.client.proxy.PlacesImpl;
import com.gwtplatform.mvp.client.proxy.PlacesWithGatekeeper;
import com.gwtplatform.mvp.client.proxy.PlacesWithGatekeeperWithParams;
...
public class ClassCollection {
    ...
    static final String placesImplClassName = PlacesImpl.class.getCanonicalName();
    ...
    static final String placesWithGatekeeperClassName = PlacesWithGatekeeper.class.getCanonicalName();
    static final String placeWithGatekeeperWithParamsClassName =
            PlaceWithGatekeeperWithParams.class.getCanonicalName();
    static final String placesWithGatekeeperWithParamsClassName =
            PlacesWithGatekeeperWithParams.class.getCanonicalName();
