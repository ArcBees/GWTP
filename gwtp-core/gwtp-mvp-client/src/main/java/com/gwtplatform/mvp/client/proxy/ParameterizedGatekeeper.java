...
/**
 * Specialized {@link Gatekeeper} which needs additional paramaters
 * in order to find out if the protected {@link Place} can be revealed.
 * </pre>
 * Example of use:
 * <pre>
 * public class HasAllRolesGatekeeper implements ParameterizedGatekeeper {
 *
 ...
 * method returning this {@link ParameterizedGatekeeper} if you want to use it
 * with the {@link com.gwtplatform.mvp.client.annotations.GatekeeperParams}
 * annotation.
 * <p />
 * You should usually bind your {@link ParameterizedGatekeeper} as a singleton.
 *
 * @author Juan Carlos González
 */
public interface ParameterizedGatekeeper extends Gatekeeper {

  /**
   * Sets the parameters required by this {@link ParameterizedGatekeeper}
   ...
   * canReveal method.
   */
  ParameterizedGatekeeper withParams(String[] params);
}
