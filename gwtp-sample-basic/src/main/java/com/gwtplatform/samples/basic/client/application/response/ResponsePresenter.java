...
public class ResponsePresenter extends Presenter<ResponsePresenter.MyView, ResponsePresenter.MyProxy> {
    /**
     * {@link com.gwtplatform.samples.basic.client.application.response.ResponsePresenter}'s proxy.
     */
    @ProxyCodeSplit
    ...
    /**
     * {@link com.gwtplatform.samples.basic.client.application.response.ResponsePresenter}'s view.
     */
    ...
    public ResponsePresenter(EventBus eventBus, MyView view, MyProxy proxy, PlaceManager placeManager,
            DispatchAsync dispatcher, TextService textService) {
    ...
    public void prepareFromRequest(PlaceRequest request) {
        ...
        textToServer = request.getParameter(textToServerParam, "");
    }
    ...
    protected void onReset() {
        ...
        dispatcher.execute(textService.createText(textToServer), new AsyncCallback<SmallResult>() {
            @Override
            ...
            @Override
            public void onSuccess(SmallResult result) {
                getView().setServerResponse(result.getMyResult());
            }
        });
    }
}
